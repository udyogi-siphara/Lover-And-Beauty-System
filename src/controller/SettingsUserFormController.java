...
public class SettingsUserFormController {
    ...
    public JFXPasswordField pwdConfirmPassowrd;
    public JFXPasswordField pwdOldPassword;
    public JFXTextField txtOldPasswd;
    public JFXTextField txtNePasswrd;
    public JFXTextField txtConfPassword;
    ...
    private void storeValidations() {
        ...
        map.put(txtOldPasswd, oldPasswordPattern);
        map.put(txtNePasswrd, newPasswordPattern);
        map.put(txtConfPassword, confirmPasswordPattern);
    }
