...
public class OrderUserFormController {
    ...
    public void initialize(){
        ...
        cmbItem.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            ...
            try {
                result = CrudUtil.execute("SELECT * FROM item WHERE name=?", newValue);
    ...
    public void btnAddCustomerIdOnAction(ActionEvent actionEvent) throws IOException {
        lordWidow2("../views/AddCustomerForm.fxml","Add Customer");
    }

    public void btnAddItemsOnAction(ActionEvent actionEvent) throws IOException {
    ...
    public void btnPayOnAction(ActionEvent actionEvent) {
        ...
        paramMap.put("Order Id", orderId);// id = report param name // customerID = UI typed value
